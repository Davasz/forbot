...
let saudacao = ["Olá, meu nome é ForBot!", "Oi, eu sou um robo chamado GaBot", "Olá, eu estou ótimo", "Estou muito bem"];
...
function chatbotvoice(message) {
    ...
    if (message.includes('má postura')) {
        let finalresult = badposture[Math.floor(Math.random() * badposture.length)];
        speech.text = finalresult;
    }
    if (message.includes('postura correta')) {
        let finalresult = goodposture[Math.floor(Math.random() * goodposture.length)];
        speech.text = finalresult;
    }
    if (message.includes('dicas postura')) {
        let finalresult = clueposture[Math.floor(Math.random() * clueposture.length)];
        speech.text = finalresult;
    }
